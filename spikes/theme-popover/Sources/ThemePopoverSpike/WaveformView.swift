...
/// Ported verbatim from Sources/ManbokApp/Views/WaveformView.swift — no environment
/// dependencies in the original, so this is a straight copy. The old spike had its own
/// Capsule-based waveform (rounded bar caps, exaggerated glow); production actually
/// draws sharp-edged rects in a Canvas. That was the single biggest visual drift found.
